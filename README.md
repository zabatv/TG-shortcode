...
- **Telegram Bot** — рассылка уведомлений о новых записях всем пользователям бота
...
После сохранения бот рассылает сообщение всем пользователям бота.
...
- При новой регистрации бот рассылает сообщение всем пользователям бота
- При клике пользователя по ссылке группы админ получает уведомление: `✅ Перешёл по ссылке!`
