...
- **Telegram Bot** — рассылка уведомлений о новых записях всем, кто когда-либо писал боту
...
После сохранения бот рассылает сообщение всем `chat_users`.
...
- Бот отвечает на любое сообщение, сохраняя `chat_id`
- При новой регистрации бот рассылает уведомление всем сохранённым `chat_id`
- Webhook установлен на `POST /telegram-webhook`
- Для ручной установки: `POST /set-webhook`
>>>>>>> 19caee8 (Add README)
